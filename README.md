...
- Vercel production uses [`api/samurai.js`](/Users/semenkr/Project/IT-Incubator/todolist-01/api/samurai.js) as a proxy so SamuraiJS mutations do not depend on frontend domain whitelisting.
